...
namespace TonSdk.Client
{
    ...
    public struct TransactionsInformationResultExtended
    {
        ...
        internal TransactionsInformationResultExtended(OutTransactionsResult outTransactionsResult)
        {
            Address = new Address(outTransactionsResult.Address.AccountAddress);
            UTime = (uint)outTransactionsResult.Utime;
            Data = Cell.From(outTransactionsResult.Data);
        ...
        internal TransactionsInformationResultExtended(OutV3TransactionsResult outTransactionsResult)
        {
            Address = new Address(outTransactionsResult.Account);
            UTime = (uint)outTransactionsResult.Now;
            Data = null;
